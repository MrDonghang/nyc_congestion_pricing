"""One-off batch renderer: produce the same 6-figure set as 04_geo_visualize.py
for tft × test across all available (mode, direction) combos. Writes PNGs to
``outputs/figures/<mode>_tft_test{_dir}/`` matching the chronos layout.
"""
...
def render(mode: str, direction: str) -> None:
    ...
    # 2. Choropleth: cumulative relative effect
